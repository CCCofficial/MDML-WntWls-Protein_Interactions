...
for iteration in range(number_of_repeats):
    ...
    rfGridSearch = GridSearchCV(rf_pipeline, param_grid=RF_param_grid, scoring='accuracy', refit=False, n_jobs=66, cv=rkf, verbose=4, return_train_score=True) # 3 iteraitions
