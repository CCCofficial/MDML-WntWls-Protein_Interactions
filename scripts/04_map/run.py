...
# return (len(number of pairs), (2)), first col has wnt resid, second has wls resid
...
output_dir = f"{currDir}/04_map/output"
os.makedirs(output_dir, exist_ok=True)

np.savetxt(f"{output_dir}/WNT{SYSTEM}_threshhold{distance_threshhold}_labels.txt", converted_fit_into_8a_str, fmt='%s')
